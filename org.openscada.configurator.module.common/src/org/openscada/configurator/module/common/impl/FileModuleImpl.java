...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>File Module</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openscada.configurator.module.common.impl.FileModuleImpl#getPath <em>Path</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FileModuleImpl extends EObjectImpl implements FileModule
{
    /**
    ...
    {
        return CommonPackage.Literals.FILE_MODULE;
    }
    ...
    public EList<String> getPath ()
    {
        if ( path == null )
        {
            path = new EDataTypeUniqueEList<String> ( String.class, this, CommonPackage.FILE_MODULE__PATH );
        }
        return path;
    }
