 ...
 * $Id$
 */
package org.openscada.configurator.module.common.network.util;
...
public class NetworkAdapterFactory extends AdapterFactoryImpl
{
    ...
    protected NetworkSwitch<Adapter> modelSwitch = new NetworkSwitch<Adapter> () {
        @Override
        public Adapter caseNetworkModule ( NetworkModule object )
        {
            return createNetworkModuleAdapter ();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.openscada.configurator.module.common.network.NetworkModule <em>Module</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createNetworkModuleAdapter ()
    {
        return null;
    }
