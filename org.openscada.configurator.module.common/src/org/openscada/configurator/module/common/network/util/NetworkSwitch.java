...
public class NetworkSwitch<T> extends Switch<T>
{
    ...
    protected T doSwitch ( int classifierID, EObject theEObject )
    {
        switch ( classifierID )
        {
            ...
            {
                NetworkModule networkModule = (NetworkModule)theEObject;
                T result = caseNetworkModule ( networkModule );
                if ( result == null )
                    result = caseModule ( networkModule );
                if ( result == null )
     ...
     * @generated
     */
    public T caseNetworkModule ( NetworkModule object )
    {
        return null;
    }
