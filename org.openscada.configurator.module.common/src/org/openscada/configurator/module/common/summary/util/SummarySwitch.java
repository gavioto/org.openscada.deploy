 ...
 * @generated
 */
public class SummarySwitch<T> extends Switch<T>
{
    /**
    ...
    protected T doSwitch ( int classifierID, EObject theEObject )
    {
        switch ( classifierID )
        {
            case SummaryPackage.GENERATE_SUMMARIES:
            {
                ...
                T result = caseGenerateSummaries ( generateSummaries );
                if ( result == null )
                    result = caseModule ( generateSummaries );
                if ( result == null )
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Generate Summaries</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Generate Summaries</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseGenerateSummaries ( GenerateSummaries object )
    {
        return null;
    }
