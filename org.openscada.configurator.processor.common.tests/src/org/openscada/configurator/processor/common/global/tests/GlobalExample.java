...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>global</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class GlobalExample
{
    ...
    public static void main ( String[] args )
    {
        ...
        //
        resourceSet.getPackageRegistry ().put ( GlobalPackage.eNS_URI, GlobalPackage.eINSTANCE );
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.global" ) );
                TransformSiteToGlobal root = GlobalFactory.eINSTANCE.createTransformSiteToGlobal ();
