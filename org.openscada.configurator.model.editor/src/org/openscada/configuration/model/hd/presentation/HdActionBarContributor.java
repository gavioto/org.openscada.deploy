...
/**
 * This is the action bar contributor for the Hd model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HdActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
    /**
     ...
     * @generated
     */
    protected IAction showPropertiesViewAction = new Action ( ConfiguratorEditorPlugin.INSTANCE.getString ( "_UI_ShowPropertiesView_menu_item" ) ) {
        @Override
        public void run ()
        {
            try
     ...
     * @generated
     */
    protected IAction refreshViewerAction = new Action ( ConfiguratorEditorPlugin.INSTANCE.getString ( "_UI_RefreshViewer_menu_item" ) ) {
        @Override
    ...
    {
        toolBarManager.add ( new Separator ( "hd-settings" ) );
        toolBarManager.add ( new Separator ( "hd-additions" ) );
    }
    ...
    public void contributeToMenu ( IMenuManager menuManager )
    {
        ...
        IMenuManager submenuManager = new MenuManager ( ConfiguratorEditorPlugin.INSTANCE.getString ( "_UI_HdEditor_menu" ), "org.openscada.configuration.model.hdMenuID" );
