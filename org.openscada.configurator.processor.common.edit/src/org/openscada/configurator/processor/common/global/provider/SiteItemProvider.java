...
public class SiteItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    ...
    /**
     * This adds a property descriptor for the Akn Pattern feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( Object object )
    {
        if ( childrenFeatures == null )
        {
            ...
            childrenFeatures.add ( GlobalPackage.Literals.SITE__AKN_PATTERN );
        }
    ...
    protected void collectNewChildDescriptors ( Collection<Object> newChildDescriptors, Object object )
    {
        ...
        newChildDescriptors.add ( createChildParameter ( GlobalPackage.Literals.SITE__AKN_PATTERN, CommonFactory.eINSTANCE.createFromString ( CommonPackage.Literals.PATTERN, null ) ) ); // TODO: ensure this is a valid literal value
    }
