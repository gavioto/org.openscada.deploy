 ...
 * <ul>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getDevice <em>Device</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getAlias <em>Alias</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isDefaultChain <em>Default Chain</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getLocalMin <em>Local Min</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isLocalMinAck <em>Local Min Ack</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getLocalMax <em>Local Max</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isLocalMaxAck <em>Local Max Ack</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isLocalHighHighAvailable <em>Local High High Available</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isLocalHighHighAck <em>Local High High Ack</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getLocalHighHighPreset <em>Local High High Preset</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isEventCommand <em>Event Command</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isLocalManual <em>Local Manual</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isRemoteManual <em>Remote Manual</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getSystem <em>System</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getComponent <em>Component</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isRemoteMin <em>Remote Min</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isRemoteMax <em>Remote Max</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isRemoteHighHigh <em>Remote High High</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isRemoteHigh <em>Remote High</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isRemoteLow <em>Remote Low</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isRemoteLowLow <em>Remote Low Low</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isLocalHighAvailable <em>Local High Available</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isLocalHighAck <em>Local High Ack</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getLocalHighPreset <em>Local High Preset</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isLocalLowAvailable <em>Local Low Available</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isLocalLowAck <em>Local Low Ack</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getLocalLowPreset <em>Local Low Preset</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isLocalLowLowAvailable <em>Local Low Low Available</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isLocalLowLowAck <em>Local Low Low Ack</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getLocalLowLowPreset <em>Local Low Low Preset</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isRemoteBool <em>Remote Bool</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isInput <em>Input</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isOutput <em>Output</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getLocalBool <em>Local Bool</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isLocalScaleAvailable <em>Local Scale Available</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getLocalScaleFactor <em>Local Scale Factor</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getLocalScaleOffset <em>Local Scale Offset</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isListMonitorPreset <em>List Monitor Preset</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isListMonitorListIsAlarm <em>List Monitor List Is Alarm</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isListMonitorAckRequired <em>List Monitor Ack Required</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getListMonitorItems <em>List Monitor Items</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#getDebugInformation <em>Debug Information</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isLocalBoolAvailable <em>Local Bool Available</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isLocalBoolAck <em>Local Bool Ack</em>}</li>
 *   <li>{@link com.inavare.vims.iolist.model.impl.ItemImpl#isIgnoreSummary <em>Ignore Summary</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
