...
/**
 * This is the item provider adapter for a {@link org.openscada.deploy.iolist.model.ScriptModule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScriptModuleItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    ...
    {
        itemPropertyDescriptors.add ( createItemPropertyDescriptor ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (), getResourceLocator (), getString ( "_UI_ScriptModule_data_feature" ), getString ( "_UI_PropertyDescriptor_description", "_UI_ScriptModule_data_feature", "_UI_ScriptModule_type" ), ModelPackage.Literals.SCRIPT_MODULE__DATA, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null ) );
    }
    ...
    {
        itemPropertyDescriptors.add ( createItemPropertyDescriptor ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (), getResourceLocator (), getString ( "_UI_ScriptModule_resource_feature" ), getString ( "_UI_PropertyDescriptor_description", "_UI_ScriptModule_resource_feature", "_UI_ScriptModule_type" ), ModelPackage.Literals.SCRIPT_MODULE__RESOURCE, true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null ) );
    }
    ...
    {
        String label = ( (ScriptModule)object ).getData ();
