...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>output</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputExample
{
    ...
    public static void main ( String[] args )
    {
        ...
        //
        resourceSet.getPackageRegistry ().put ( OutputPackage.eNS_URI, OutputPackage.eINSTANCE );
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.output" ) );
                OutputAverages root = OutputFactory.eINSTANCE.createOutputAverages ();
