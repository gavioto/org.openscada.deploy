...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>processing</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessingExample
{
    ...
    public static void main ( String[] args )
    {
        ...
        //
        resourceSet.getPackageRegistry ().put ( ProcessingPackage.eNS_URI, ProcessingPackage.eINSTANCE );
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.processing" ) );
                ImportModule root = ProcessingFactory.eINSTANCE.createImportModule ();
