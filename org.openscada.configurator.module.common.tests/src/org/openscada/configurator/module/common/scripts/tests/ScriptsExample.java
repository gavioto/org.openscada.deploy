...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>scripts</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ScriptsExample
{
    ...
    public static void main ( String[] args )
    {
        ...
        //
        resourceSet.getPackageRegistry ().put ( ScriptsPackage.eNS_URI, ScriptsPackage.eINSTANCE );
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.scripts" ) );
                ScriptsModule root = ScriptsFactory.eINSTANCE.createScriptsModule ();
