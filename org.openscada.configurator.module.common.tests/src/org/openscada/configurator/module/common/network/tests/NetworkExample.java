...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>network</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class NetworkExample
{
    ...
    public static void main ( String[] args )
    {
        ...
        //
        resourceSet.getPackageRegistry ().put ( NetworkPackage.eNS_URI, NetworkPackage.eINSTANCE );
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.network" ) );
                NetworkModule root = NetworkFactory.eINSTANCE.createNetworkModule ();
